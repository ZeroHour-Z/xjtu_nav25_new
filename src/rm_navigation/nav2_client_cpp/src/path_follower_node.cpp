    ...
    explicit PathFollowerNode(const rclcpp::NodeOptions& options = rclcpp::NodeOptions()):
        ...
        goal_sub_ = create_subscription<geometry_msgs::msg::PoseStamped>(
            ...
            [this](const geometry_msgs::msg::PoseStamped::SharedPtr msg) {
                ...
                RCLCPP_INFO(
                    this->get_logger(),
                    "Received new goal from %s: (%.3f, %.3f, %.3f)",
        ...
        control_timer_ =
            create_wall_timer(20ms, std::bind(&PathFollowerNode::onControlTimer, this));

        RCLCPP_INFO(
            get_logger(),
            "PathFollowerNode started. Publishing target twists on %s",
