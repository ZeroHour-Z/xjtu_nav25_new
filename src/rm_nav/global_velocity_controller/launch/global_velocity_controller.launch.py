...
def generate_launch_description():
    ...
    default_sim_params = PathJoinSubstitution([
        FindPackageShare('global_velocity_controller'),
        'config',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('sim_params_file', default_value=default_sim_params),
        ...
        Node(
            ...
            parameters=[
                ...
                ParameterFile(sim_params_file, allow_substs=True),
                {
                    'map_frame': map_frame,
