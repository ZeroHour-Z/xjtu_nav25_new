...
int main(int argc, char** argv) {
    ...
    if (node->get_parameter("point_cloud_file", cloud_file)) {
        ...
        params.n_segments = node->declare_parameter("n_segments", params.n_segments);
        ...
        params.long_threshold = node->declare_parameter("long_threshold", params.long_threshold);
        params.max_long_height = node->declare_parameter("max_long_height", params.max_long_height);
        params.max_start_height =
            node->declare_parameter("max_start_height", params.max_start_height);
        params.sensor_height = node->declare_parameter("sensor_height", params.sensor_height);
