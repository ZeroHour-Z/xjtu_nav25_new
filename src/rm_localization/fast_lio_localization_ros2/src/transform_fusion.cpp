...
public:
    TransformFusionNode(): rclcpp::Node("transform_fusion") {
        ...
        sub_odom_ = this->create_subscription<nav_msgs::msg::Odometry>(
            "/odom",
            qos,
            std::bind(&TransformFusionNode::cbSaveCurOdom, this, std::placeholders::_1)
        );
        sub_map_to_odom_ = this->create_subscription<nav_msgs::msg::Odometry>(
            "/map_to_odom",
            qos,
            std::bind(&TransformFusionNode::cbSaveMapToOdom, this, std::placeholders::_1)
        );
        ...
        timer_ = this->create_wall_timer(
            ...
            std::bind(&TransformFusionNode::onTimer, this)
        );
