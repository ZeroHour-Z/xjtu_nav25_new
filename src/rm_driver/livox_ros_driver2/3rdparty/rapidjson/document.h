...
public:
  ...
  */
    explicit GenericValue(Type type) RAPIDJSON_NOEXCEPT: data_() {
        static const uint16_t defaultFlags[] = { kNullFlag,     kFalseFlag, kTrueFlag,
  ...
  */
    GenericValue& AddMember(GenericValue& name, GenericValue& value, Allocator& allocator) {
        ...
        if (o.size >= o.capacity)
            MemberReserve(
                o.capacity == 0 ? kDefaultObjectCapacity : (o.capacity + (o.capacity + 1) / 2),
                allocator
            );
  ...
  */
    GenericValue& PushBack(GenericValue& value, Allocator& allocator) {
        ...
        if (data_.a.size >= data_.a.capacity)
            Reserve(
                data_.a.capacity == 0 ? kDefaultArrayCapacity
  ...
  */
    ...
    bool Accept(Handler& handler) const {
        switch (GetType()) {
            ...
            case kStringType:
                return handler
                    .String(GetString(), GetStringLength(), (data_.f.flags & kCopyFlag) != 0);
...
private:
    ...
    enum {
        ...
        kNumberAnyFlag = kNumberType | kNumberFlag | kIntFlag | kInt64Flag | kUintFlag | kUint64Flag
            | kDoubleFlag,
...
private:
    ...
    void ClearStack() {
        if (Allocator::kNeedFree)
            ...
            ) // Here assumes all elements in stack array are GenericValue
...
public:
    ...
    GenericObject
    AddMember(StringRefType name, StringRefType value, AllocatorType& allocator) const {
        value_.AddMember(name, value, allocator);
        return *this;
    }
    template<typename T>
