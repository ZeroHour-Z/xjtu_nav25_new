...
#define RAPIDJSON_ENABLEIF_RETURN(cond, returntype) \
    typename ::RAPIDJSON_NAMESPACE::internal:: \
        EnableIf<RAPIDJSON_REMOVEFPTR_(cond), RAPIDJSON_REMOVEFPTR_(returntype)>::Type

#define RAPIDJSON_DISABLEIF_RETURN(cond, returntype) \
    typename ::RAPIDJSON_NAMESPACE::internal:: \
        DisableIf<RAPIDJSON_REMOVEFPTR_(cond), RAPIDJSON_REMOVEFPTR_(returntype)>::Type
